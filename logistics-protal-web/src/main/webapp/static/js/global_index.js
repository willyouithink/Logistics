...
function timeFun() {
    ...
    if (nowtimes >= 1414944000000 && nowtimes <= 1415203199000) {
        $(".q_ticket").css("background", "url(http://p.sfimg.cn/gold/images/20141105/20141105153125147.jpg) no-repeat center");
        ...
        $(".q_ticket").css("background", "url(http://p.sfimg.cn/gold/images/20141110/20141110183526651.jpg) no-repeat center");
    ...
    if (nowtimes >= 1442246400000 && nowtimes <= 1443456000000) {
        $('.index_promo').html('<a href="/html/activity/1439445027.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150914/20150914154053657.gif"></a>');
        $('.index_promo').show();
    } else if (nowtimes >= 1421337600000 && nowtimes <= 1421596799000) {
        $('.index_promo').html('<a href="/html/activity/1421129064.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150115/20150115142344692.gif"></a>');
        $('.index_promo').show();
    } else if (nowtimes >= 1421596800000 && nowtimes <= 1421942399000) {
        $('.index_promo').html('<a href="/html/activity/1421129153.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150115/20150115142410434.gif"></a>');
        $('.index_promo').show();
    } else if (nowtimes >= 1421942400000 && nowtimes <= 1422287999000) {
        $('.index_promo').html('<a href="/html/activity/1421129191.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150115/20150115142446150.gif"></a>');
        $('.index_promo').show();
    } else if (nowtimes >= 1422374400000 && nowtimes <= 1422547199000) {
        $('.index_promo').html('<a href="/html/activity/1421129223.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150115/20150115142512700.gif"></a>');
        $('.index_promo').show();
    } else if (nowtimes >= 1422547200000 && nowtimes <= 1423929599000) {
        $('.index_promo').html('<a href="/html/activity/1422341986.html" target="_blank"><img src="http://p.sfimg.cn/gold//images/20150129/20150129142152888.gif"></a>');
        $('.index_promo').show();
    } else if (nowtimes >= 1430755200000 && nowtimes <= 1433087999000) {
        $('.index_promo').html('<a href="/yup/264/7225.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150504/20150504153349695.gif"></a>');
        $('.index_promo').show();
    }
    ...
    if (nowtimes >= 1421337600000 && nowtimes <= 1439568000000) {
        $('.index_rfloat').html('<a href="http://survey4.iclick.cn/survey/20150106/default.asp?fid=12&t=y2i71cmh" target="_blank" rel="nofollow"><img src="http://p.sfimg.cn/gold/images/20150115/20150115142627540.jpg"></a><div class="J_rclose">关闭</div>');
        $('.index_rfloat').show();
    } else if (nowtimes >= 1429200000000 && nowtimes <= 1430064000000) {
        $('.index_rfloat').html('<a href="/html/activity/1428992676.html" target="_blank"><img src="http://p.sfimg.cn/gold/images/20150415/20150415172520852.png"></a><div class="J_rclose">关闭</div>');
        $('.index_rfloat').show();
    }
    //右侧广告位关闭
        ...
        if ((str.nowList.length < 1 && str.nextList.length > 0)) {
            ...
            for (i = 0; i < 5; i++) {
                ...
                if (temp) {
                    ...
                    $nowCon += '<div class="pImg"><img src="http://p.sfimg.cn/article/1411457535.jpg" alt="" /></div>';
        ...
        if (str.nextList.length < 1) {
            ...
            for (i = 0; i < 5; i++) {
                ...
                if (temp) {
                    ...
                    $nextCon += '<div class="pImg"><img src="http://p.sfimg.cn/article/1411457535.jpg" alt="" /></div>';
