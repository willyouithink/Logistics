...
public class PropKit {
	...
	public static Prop use(String fileName) {
		return use(fileName, com.uu.protal.utils.Const.DEFAULT_ENCODING);
	}
	...
	public static Prop use(String fileName, String encoding) {
		...
		if (result == null) {
			...
			if (com.uu.protal.utils.PropKit.prop == null) {
				com.uu.protal.utils.PropKit.prop = result;
			}
		}
		return result;
	}
	...
	public static Prop useless(String fileName) {
		...
		if (com.uu.protal.utils.PropKit.prop == previous) {
			com.uu.protal.utils.PropKit.prop = null;
		}
		return previous;
	}
